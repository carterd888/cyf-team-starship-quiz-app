...
const QuizQuestion = ({ mentorEmail, newQuiz }) => {
  // const mentorDetail = props.location.state.mentorDetail;
  // const newQuiz = props.location.state.newQuiz;
  ...
  function handleSubmit(e) {
    e.preventDefault();
    console.log(
      `Id is ${quizName} question is: ${question} correct answer: ${correctAnswer}, first wrong answer: ${wrongAnswer1} , second wrong answer: ${wrongAnswer2}, ` +
    ...
    <div className="container">
      ...
      <form>
        ...
        <button className="submit-button" type="submit" onClick={handleSubmit}>
          click here to submit the questions
        </button>
        <Link
          to={{
